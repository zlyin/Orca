...
class MiniGoogLeNet:
	@staticmethod
	def conv_module(x, K, kernel, strides, chanDim, padding="same"):
		# CONV => BN => RELU
		x = Conv2D(K, kernel, strides=strides, padding=padding)(x)
	...
	def inception_module(x, numK1x1, numK3x3, chanDim):
		# define two CONV1x1 & Conv3x3, then concatenate across the
		# channel dimension
	...
	def build(width, height, depth, classes):
		...
		# define the model input shape and first CONV module
